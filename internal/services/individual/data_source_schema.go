...
var _ datasource.DataSourceWithConfigValidators = (*IndividualDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"source_id": schema.StringAttribute{
				Description: "Optional identifier indicating the source of the individual record.",
				Computed:    true,
			},
			...
			"workspace_id": schema.StringAttribute{
				Description: "Identifier of the workspace to which the individual belongs.",
				Computed:    true,
			},
			"aml_suspicions": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[IndividualAmlSuspicionsDataSourceModel](ctx),
			...
			"certificat": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[IndividualCertificatDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"id": schema.StringAttribute{
			...
			"checks": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[IndividualChecksDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
			...
			"documents": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[IndividualDocumentsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id": schema.StringAttribute{
						...
						"checks": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[IndividualDocumentsChecksDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"masked": schema.BoolAttribute{
										Description: "Indicates whether the result or data is masked/hidden.",
						...
						"tables": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[IndividualDocumentsTablesDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
						...
						"values": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[IndividualDocumentsValuesDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
			...
			"identity_card": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[IndividualIdentityCardDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"id": schema.StringAttribute{
			...
			"person": schema.SingleNestedAttribute{
				Description: "Personal details of the individual, such as name, date of birth, and contact info.",
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[IndividualPersonDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"birthday": schema.StringAttribute{
						Description: "Date of birth, formatted as DD/MM/YYYY.",
						Computed:    true,
					},
					...
					"face_image_signed_url": schema.StringAttribute{
						Description: "Signed URL linking to the person’s face image.",
						Computed:    true,
					},
					"first_name": schema.StringAttribute{
					...
					"full_name": schema.StringAttribute{
						Description: "Full name of the person, typically concatenation of first and last names.",
						Computed:    true,
					},
					"gender": schema.StringAttribute{
						Description: `Gender of the individual (e.g., "M" for male, "F" for female).`,
						Computed:    true,
					},
					"last_name": schema.StringAttribute{
			...
			"properties": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[IndividualPropertiesDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"name": schema.StringAttribute{
			...
			"risk": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[IndividualRiskDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
			...
			"tags": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[IndividualTagsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
			...
			"technical_data": schema.SingleNestedAttribute{
				Description: "Technical metadata related to the request (e.g., QR code settings, language).",
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[IndividualTechnicalDataDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
...
func (d *IndividualDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *IndividualDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
